...
// FAILING + IGNORED plus the implicit "passed" must stay exhaustive over TestStatus: any status in
// neither set is treated as passing. Add any new TestStatus value to the right set here.
